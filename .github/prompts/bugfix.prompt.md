...
13. 修复代码、配置、脚本、SQL 或文档后，必须在根目录 `CHANGELOG.MD` 顶部追加一条记录（日期、类别、范围、摘要、验证），与本次改动在同一工作区变更中完成。
14. 如果无法完成复现或验证，必须说明原因、当前证据和剩余风险。
15. 如果对应 change 的修复任务已完成，结尾应提示 `archive`。
16. 最终输出使用以下结构：
