...
values
  ...
  ('page:quality-rework-repair', 'page', 'quality', 'pc', '质量返工返修')
...
create policy "Quality rework repairs admin all" on public.quality_rework_repairs for all to authenticated using (public.is_admin()) with check (public.is_admin());
