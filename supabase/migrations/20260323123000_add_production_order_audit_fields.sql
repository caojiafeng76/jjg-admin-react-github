...
create or replace function public.sync_production_order_audit_fields()
returns trigger
language plpgsql
as $$
begin
...
create trigger sync_production_order_audit_fields
before insert or update of is_audited, audited_at on public.production_orders
for each row
execute function public.sync_production_order_audit_fields();
