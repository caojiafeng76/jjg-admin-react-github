  ...
  items as (
    select orders.created_at,
      ...
      jsonb_build_object(
        ...
        ), 'transferDetails', coalesce(mt_details.rows, '[]'::jsonb), 'finishedQuantity', orders.transfer_quantity, 'completionRate', orders.completion_rate, 'yieldRate', orders.yield_rate, 'productionStatus', orders.production_status, 'productionRows', coalesce(prod_details.rows, '[]'::jsonb)
      ) as value
