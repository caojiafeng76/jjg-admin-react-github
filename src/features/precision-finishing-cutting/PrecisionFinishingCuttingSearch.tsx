...
interface Props {
  onSearch: (values: PrecisionFinishingCuttingSearchValues) => void
  onReset: () => void
  employees: { id: string; name: string }[]
  initialValues?: PrecisionFinishingCuttingSearchValues
  mobile?: boolean
  showEmployeeFilter?: boolean
}

export default function PrecisionFinishingCuttingSearch({
  onSearch,
  onReset,
  employees,
  initialValues,
  ...
  function handleFinish(values: PrecisionFinishingCuttingSearchValues) {
    onSearch({
      startDate:
    ...
    >
      ...
      <Form.Item name="isAudited" className="mb-0">
        <Select
          ...
          options={[...PRECISION_FINISHING_CUTTING_AUDIT_OPTIONS]}
        />
      </Form.Item>
