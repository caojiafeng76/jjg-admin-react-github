...
export default function LaborProtectionPublicRequisitionPage() {
  ...
  return (
    <div className="flex h-dvh flex-col overflow-hidden bg-[radial-gradient(circle_at_top,rgba(217,119,6,0.16),transparent_28%),linear-gradient(180deg,#fbf7ef_0%,#fffdf8_42%,#f0ebe2_100%)] text-slate-900">
