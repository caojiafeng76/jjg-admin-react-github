...
import {
  getLaborProtectionPublicQrPath,
  getLaborProtectionPublicQrValue,
} from './laborProtectionPublicQr'
        ...
        <style>
          ...
          * {
          ...
          .poster {
            ...
            gap: 12mm;
            background:
              radial-gradient(circle at top, rgba(217, 119, 6, 0.12), transparent 24%),
      ...
      <body>
        <main class="poster">
          <header class="headline">
            <h1 class="headline-title">领用劳保</h1>
          ...
          <section class="qr-shell">
            ...
            <p class="hint">微信扫一扫，填写领取人、岗位和数量后提交</p>
          </section>

          <footer class="note">
            <div class="note-label">Scan Entry</div>
            <p class="note-text">扫码后将直接打开劳保领用登记 H5 页面，无需登录。</p>
...
export function usePrintLaborProtectionPublicQrPoster() {
  ...
  async function printPoster() {
    try {
      ...
      const qrPath = getLaborProtectionPublicQrPath()
      const qrValue = getLaborProtectionPublicQrValue()
      ...
      console.error('打印劳保二维码海报失败:', error)
      message.error(
