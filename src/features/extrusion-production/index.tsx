            ...
            await updateMutation.mutateAsync({
              ...
              payload: {
                header: {
                  ...
                  shift_leader_employee_id: targetRecord.shift_leader_employee_id,
                  operator_employee_id: targetRecord.operator_employee_id,
                  inspector_employee_id: targetRecord.inspector_employee_id,
