        ...
        return (
          <article
            ...
            className={`relative overflow-hidden rounded-2xl ${
              isMatched
                ? 'border border-slate-200 bg-white shadow-[0_4px_20px_rgba(15,23,42,0.08)] dark:border-slate-700 dark:bg-slate-800'
                : 'border border-amber-200 bg-gradient-to-br from-amber-50/80 to-orange-50/80 shadow-[0_4px_20px_rgba(245,158,11,0.15)] dark:border-amber-500/30 dark:from-amber-500/10 dark:to-orange-500/10'
            }`}
          >
            {/* Accent Line */}
            <div
            ...
            <div className="p-4 pl-5">
              ...
              <div className="mb-3 flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col items-end gap-1.5">
                  <span className="inline-flex items-center rounded-full bg-slate-800 px-2.5 py-0.5 text-xs font-semibold text-white shadow-sm dark:bg-slate-600">
                    理论工时
                  </span>
                  {!isMatched && (
              ...
              <div className="mb-4 grid grid-cols-2 gap-2.5">
                <div className="flex items-center gap-2 rounded-xl bg-slate-50/80 px-3 py-2.5 dark:bg-slate-800/60">
                  <WrenchScrewdriverIcon className="h-4 w-4 flex-shrink-0 text-slate-400 dark:text-slate-500" />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-medium tracking-wider text-slate-400 uppercase dark:text-slate-500">
                      工序
                    </div>
                ...
                <div className="flex items-center gap-2 rounded-xl bg-slate-50/80 px-3 py-2.5 dark:bg-slate-800/60">
                  <UserCircleIcon className="h-4 w-4 flex-shrink-0 text-slate-400 dark:text-slate-500" />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-medium tracking-wider text-slate-400 uppercase dark:text-slate-500">
                      工种
                    </div>
                ...
                <div className="flex items-center gap-2 rounded-xl bg-slate-50/80 px-3 py-2.5 dark:bg-slate-800/60">
                  <BuildingOfficeIcon className="h-4 w-4 flex-shrink-0 text-slate-400 dark:text-slate-500" />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-medium tracking-wider text-slate-400 uppercase dark:text-slate-500">
                      客户
                    </div>
              ...
              {/* Stats Row */}
              <div className="mb-4 grid grid-cols-2 gap-2.5">
                <div className="flex items-center gap-2 rounded-xl border border-cyan-100 bg-gradient-to-br from-cyan-50/80 to-teal-50/80 px-3 py-2.5 dark:border-cyan-500/30 dark:from-cyan-500/10 dark:to-teal-500/10">
                  <ClockIcon className="h-4 w-4 flex-shrink-0 text-cyan-500" />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-medium tracking-wider text-cyan-600/70 uppercase dark:text-cyan-400/70">
                      理论工时
                    </div>
                ...
                <div className="flex items-center gap-2 rounded-xl border border-emerald-100 bg-gradient-to-br from-emerald-50/80 to-green-50/80 px-3 py-2.5 dark:border-emerald-500/30 dark:from-emerald-500/10 dark:to-green-500/10">
                  <ChartBarIcon className="h-4 w-4 flex-shrink-0 text-emerald-500" />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] font-medium tracking-wider text-emerald-600/70 uppercase dark:text-emerald-400/70">
                      日标准产能
                    </div>
              ...
              {/* Process Details */}
              <div className="mb-4 grid grid-cols-2 gap-2.5">
                <div className="rounded-xl bg-slate-50/80 px-3 py-2.5 dark:bg-slate-800/60">
                  <div className="text-[10px] font-medium tracking-wider text-slate-400 uppercase dark:text-slate-500">
                    工装治具
                  </div>
                  <div className="truncate text-sm font-medium text-slate-700 dark:text-slate-300">
                ...
                <div className="col-span-2 rounded-xl bg-slate-50/80 px-3 py-2.5 dark:bg-slate-800/60">
                  <div className="text-[10px] font-medium tracking-wider text-slate-400 uppercase dark:text-slate-500">
                    说明
                  </div>
                  <div className="text-sm font-medium break-words text-slate-700 dark:text-slate-300">
